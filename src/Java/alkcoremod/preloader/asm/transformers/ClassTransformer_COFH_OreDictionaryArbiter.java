...
public class ClassTransformer_COFH_OreDictionaryArbiter {
	...
	public void injectMethod(String aMethodName) {	
		...
		if (aMethodName.equals("registerOreDictionaryEntry")) {
			Preloader_Logger.LOG("COFH OreDictionaryArbiter Patch", Level.INFO, "Injecting "+aMethodName+" into "+className+". ItemStack: "+aItemStack);
			...
			mv.visitMethodInsn(INVOKESTATIC, "alkcoremod/preloader/asm/transformers/ClassTransformer_COFH_OreDictionaryArbiter$FixCOFH", "registerOreDictionaryEntry", "(L"+aItemStack+";Ljava/lang/String;)V", false);
			Label l1 = new Label();
			mv.visitLabel(l1);
		...
		Preloader_Logger.LOG("COFH OreDictionaryArbiter Patch", Level.INFO, "Method injection complete.");		
	...
	public static final class localClassVisitor extends ClassVisitor {
		...
		public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {			
			if (name.equals("registerOreDictionaryEntry")) {
				Preloader_Logger.LOG("COFH OreDictionaryArbiter Patch", Level.INFO, "Removing method "+name);
				return null;
			}		
